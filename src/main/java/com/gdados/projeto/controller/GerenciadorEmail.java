...
public class GerenciadorEmail {
    ...
    public void enviarEmail(Contato contato) {
        ...
        try {
            ...
            InternetAddress[] toUser = InternetAddress.parse(contato.getEmail());

            message.setRecipients(Message.RecipientType.TO, toUser);
            message.setSubject(contato.getSegmento());//Assunto
            message.setText(contato.getDescricao() 
                    + "</br>" + "obrigado " 
                    + contato.getNome() 
                    + " por entrar em conotato conosco.");
