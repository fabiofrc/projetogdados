package com.gdados.projeto.util.upload;
...
public class FotoService implements Serializable {
    ...
    @PostConstruct
    void init() {
        Path raizAplicacao = getDefault().getPath(System.getProperty("user.home"), ".modulo-pagamento");
        diretorioRaiz = raizAplicacao.resolve("arquivos");
        diretorioRaizTemp = getDefault().getPath(System.getProperty("java.io.tmpdir"), "modulo-pagamento-temp");
